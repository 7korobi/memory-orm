...
/******/ 	return __webpack_require__(__webpack_require__.s = "./__tests__/sort_spec.coffee");
/******/ })
/************************************************************************/
/******/ ({
...
keys.map(function (key) {
  return describe(key, function () {
    return test('sort snapshot', function () {
      return expect(Mem.Query[key].$sort).toMatchSnapshot();
    });
  });
});
...
/******/ })));
//# sourceMappingURL=sort_spec.js.map