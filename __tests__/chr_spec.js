...
/******/ 	return __webpack_require__(__webpack_require__.s = "./__tests__/chr_spec.coffee");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./__tests__/chr_spec.coffee":
/*!***********************************!*\
  !*** ./__tests__/chr_spec.coffee ***!
  \***********************************/
...
test_is = function (target, list, key, o) {
  return test(`${target} ${list} ${key}`, function () {
    var base;
    base = Mem.State.base({
      list
    });
...
describe("transaction", function () {
  var $format, $memory, $sort, json, key, list_id, o, results;
  ...
  for (list_id in json) {
    ...
    results.push(function () {
      ...
      for (key in $memory) {
        o = $memory[key];
        results1.push(test_is("$memory", list_id, key, o));
      }
...
describe("faces", function () {
  test('reduce name_head snapshot', function () {
    ...
    return expect(function () {
      ...
      ref = Mem.Query.faces.reduce.name_head;
      results = [];

      for (i = 0, len = ref.length; i < len; i++) {
        o = ref[i];
        results.push(o != null ? o.map(function (oo) {
          return [oo.id, oo.set];
        }) : void 0);
      }
  ...
  return Mem.Query.tags.ids.map(function (tag) {
    ...
    test(`.tag(${tag}) id snapshot`, function () {
      return expect(Mem.Query.faces.tag(tag).pluck("id")).toMatchSnapshot();
    });
    test(`.tag(${tag}) name snapshot`, function () {
      return expect(Mem.Query.faces.tag(tag).pluck("name")).toMatchSnapshot();
    });
    test(`.tag(${tag}) job snapshot`, function () {
      return expect(Mem.Query.faces.tag(tag).pluck("chr_jobs.list").map(function (o) {
        return o.map(function (oo) {
          return oo.job;
        });
      })).toMatchSnapshot();
    });
    test(`.tag(${tag}) npc snapshot`, function () {
      return expect(Mem.Query.faces.tag(tag).pluck("chr_npcs.list").map(function (o) {
        return o.map(function (oo) {
          return [oo.label, oo.say_0, oo.say_1];
        });
      })).toMatchSnapshot();
    });
    return test(`.name_head(${tag}) snapshot`, function () {
      ...
      return expect(function () {
        var i, len, ref, results;
        ref = Mem.Query.faces.name_head(tag);
        results = [];
...
/******/ })));
//# sourceMappingURL=chr_spec.js.map