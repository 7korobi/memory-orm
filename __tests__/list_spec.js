...
/******/ 	return __webpack_require__(__webpack_require__.s = "./__tests__/list_spec.coffee");
/******/ })
/************************************************************************/
/******/ ({
...
keys.map(function (key) {
  return describe(key, function () {
    return test('list snapshot', function () {
      return expect(Mem.Query[key].list).toMatchSnapshot();
    });
  });
});
