...
/******/ 	return __webpack_require__(__webpack_require__.s = "./__tests__/memory_spec.coffee");
/******/ })
/************************************************************************/
/******/ ({
...
keys.map(function (key) {
  return describe(key, function () {
    return test('memory snapshot', function () {
      return expect(Mem.Query[key].memory).toMatchSnapshot();
    });
  });
});
...
/******/ })));
//# sourceMappingURL=memory_spec.js.map