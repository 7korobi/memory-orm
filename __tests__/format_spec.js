...
/******/ 	return __webpack_require__(__webpack_require__.s = "./__tests__/format_spec.coffee");
/******/ })
/************************************************************************/
/******/ ({
...
keys.map(function (key) {
  return describe(key, function () {
    return test('format snapshot', function () {
      return expect(Mem.Query[key]._finder.format).toMatchSnapshot();
    });
  });
});
...
/******/ })));
//# sourceMappingURL=format_spec.js.map